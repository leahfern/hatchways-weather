...
export default function Title(props) {
  ...
  return (
    <div
      className={`title background${cityValues[cityNames.indexOf(city.name)]}`}
    >
      <h1>
        ...
        <select onChange={handleSelect}>
          ...
          <option key="Pittsburgh" value="Pittsburgh">
            Pittsburgh, PA
          </option>
          <option key="Morgantown" value="Morgantown">
            Morgantown, WV
          </option>
          <option key="Valparaiso" value="Valparaiso">
            Valparaiso, Chile
          </option>
        </select>
